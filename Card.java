...
public class Card implements Serializable {
	...
	private String question; //whole question
	private Answer answer; //answer to the question
	private int difficulty; //difficulty of problem
	private String qtype; //type of question
	
	// Constructor taking in to necessary fields to assign to the Card's class variables.
	public Card(String question, Answer answer, int difficulty, String qtype) {
    ...
    public boolean equals(Card card) {
    	return (question.equals(card.getQuestion()) && answer.equals(card.getAnswer()) && qtype.equals(card.getType()));
